...
use crate::arch::{ConfigurationError, VcpuArchError, configure_system_for_boot, load_kernel};
#[cfg(target_arch = "aarch64")]
...
pub fn build_microvm_from_snapshot(
    ...
    // Need to alloc sys mem for steal time regions before vcpu setup
    #[cfg(target_arch = "aarch64")]
